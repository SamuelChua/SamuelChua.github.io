...
# Define your content here so it's easy to maintain
experiences:
  - company: Amazon
    location: Boston, MA
  ...
  - company: LEMUR Lab @ UCLA
    ...
    bullets:
      ...
      - Publication: 3rd Author on “Population-aware Online Mirror Descent for Mean-Field Games by Deep Reinforcement Learning,” AAMAS
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-start flex-wrap">
              <h3 class="card-title m-0">
                <span class="text-lowercase">{{ exp.company }}</span>
